...
<br />
<!--nav bar ends here-->
        <h1 align="center">View Display Laptop <button><a href="admindashboard.php" style="font-size:30px; color:darkred;">X</a></button> </h1>
                ...
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <a href='deletedisplayedlaptop.php?id=$l_id' class='colordelete'  onclick='return confirmDelete()'>Delete</a>
                            </td>
                        </tr>
                        ";
                    }

...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($laptopId) {
        $stmt = $conn->prepare("UPDATE `budget_laptops` SET l_name=?, l_model=?, l_specification=?, l_amount=?, l_image=? WHERE l_id=?");
...
<head>
    ...
    <title>Modify Budget Laptop</title>
...
<h1 style="color:#1789fc; text-align:center;">Update Budget Laptop <a href="admindashboard.php" style="font-size:30px; color:darkgreen;"> X</a></h1>
   <br>

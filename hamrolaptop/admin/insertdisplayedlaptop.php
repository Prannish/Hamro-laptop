...
<head>
    ...
    <title>insert_homepage_laptop</title>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "insert into displayed_laptops(l_name,l_model,l_specification,l_amount,l_image) values('$l_name','$l_model','$l_specification','$l_amount','$imagePath')";
...
<h1 style="color:#1789fc; text-align:center;">Insert homepage laptop <a href="admindashboard.php" style="font-size:30px; color:darkgreen;"> X</a></h1>
   <br>

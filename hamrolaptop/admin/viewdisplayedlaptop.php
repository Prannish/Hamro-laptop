...
<head>
    ...
    <title>View_displayed_laptops</title>
...
<body>
    ...
    <br />
    <!--nav bar ends here-->
        <h1 align="center">View Displayed Laptop <button><a href="admindashboard.php" style="font-size:30px; color:darkgreen;">X</a></button> </h1>
        ...
        <tbody>
            <?php
                $sql = "SELECT l_id,l_name,l_model,l_specification,l_amount,l_image,l_uploaddate from displayed_laptops";
                ...
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td>$uploaddate</td>
                            <td>
                                 <a href='modifydisplayedlaptop.php?id=$id' class='colorupdate' />Update</a>
                            <a href='deletedisplayedlaptop.php?id=$id' class='colordelete' onclick='return confirmDelete()'>Delete</a>
                            </td>
                        </tr>
                        ";
                    }

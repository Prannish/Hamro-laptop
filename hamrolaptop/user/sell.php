...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "insert into second_hand_laptops(l_name,l_model,l_specification,l_amount,l_image) values('$l_name','$l_model','$l_specification','$l_amount','$imagePath')";
...
<h1 style="color:#1789fc; text-align:center;">Sell your Laptop <a href="buy.php" style="font-size:30px; color:darkgreen;"> X</a></h1>
   <br>
    ...
    <form method="POST" action="<?php echo $_SERVER["PHP_SELF"] ?>" onsubmit="return validateForm()" enctype="multipart/form-data">
        ...
        <input type="submit" value="sell Laptop">
    </form>
    </div>

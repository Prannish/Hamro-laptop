...
<head>
  ...
  <title>Hamro _Laptop_dashboard</title>
...
<!--nav bar ends here-->
  ...
  <div> <!-- class="indexcontainer"-->
    ...
    <br>
    <br>
    <h1 style=" font-size: 50px; text-align:center;">Find Perfect Second-Hand Laptop For You</h1>
    ...
    <br>
    <!--Search bar ends-->
    <h1 style=" font-size: 20px; text-align:center;">Laptops on sale</h1>
      ...
      if ($result) {
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          <div>
            ...
            <p>Uploaded Date: $uploaddate</p>
            <p>Specification:$specification</p>
            <a href='update_laptop.php?id=$id' class='buy-btn'>Buy</a>
            <a href='add_to_cart.php?id=$id' class='cart-btn'>Add to Cart</a>
          </div>";
        }
      }
      ?>
